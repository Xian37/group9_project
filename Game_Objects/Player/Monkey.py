...
class Monkey(Player):
    def __init__(self, x, y, size, color, speed, role2_monkey):
        super().__init__(x, y, size, color, speed, health = 125,player_path = role2_monkey, name = 'You')
        self.health = 125
    def draw_health_block(self, screen):
        ...
        fill_rect = pygame.Rect(block_x, block_y + bar_height-(self.health / 125) * bar_height, bar_width, (self.health / 125) * bar_height)
        rainbow_image = pygame.transform.scale(rainbow_image, (80,525*(self.health / 125)))
